...
?>
<title>Módulo | Editar curso</title>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-warning">
                        <div class="card-header">
                            <h3 class="card-title">Editar información del curso</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                        ...
                        ?>
                            ...
                            <form role="form" method="post" action="../crud/editarCurso.php?id=<?php echo $idCursoEditar; ?>">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Nombre del curso" value="<?php echo $nombre; ?>" name="nombre" id="nombre" pattern="^[a-zA-ZáéíóúÁÉÍÓÚ0-9 ]{1,100}" required minlength="1" maxlength="100">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="time" class="form-control" placeholder="Hora de inicio" value="<?php echo $horaInicio; ?>" name="hora_inicio" id="hora_inicio" pattern="^[a-zA-Z0-9: ]{1,100}" required minlength="1" maxlength="100">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="time" class="form-control" placeholder="Hora fin" value="<?php echo $horaFin; ?>" name="hora_fin" id="hora_fin" pattern="^[a-zA-Z0-9: ]{1,100}" required minlength="1" maxlength="100">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="1" id="lunes"<?php if($lunes==1){echo "checked='true'";}?> name="lunes">
