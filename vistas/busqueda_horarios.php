...
$nombreSesion;
$apellidoSesion;
$rolPermisoMenuSesion;
$idUsuarioSesion;

          if(isset($_SESSION['usuario'])){
            $usuarioSesion = $_SESSION['usuario'];
            $nombreSesion = $usuarioSesion->getNombres();
            $apellidoSesion = $usuarioSesion->getApellidos();
            $rolPermisoMenu = $usuarioSesion->getIdRol();
            $idUsuarioSesion = $usuarioSesion->getId();
          }else{
            session_start(); 
            $usuarioSesion = $_SESSION['usuario'];
            $nombreSesion = $usuarioSesion->getNombres();
...
<div class="card-body">
                ...
                for($i=0; $i<sizeof($cursoArray);$i++){
                  ...
                  //Imprimimos botones
                    ...
                    echo"<td><a type='submit' href='curso_vista.php?id=$id&modoVista=2'class='btn bg-gradient-success'>
