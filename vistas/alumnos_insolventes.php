...
function filtrarPorAnioGrado(){
    ...
    $.ajax({
        type:"POST",
        url:"cargar_alumnos_insolventes.php?idGrado=" + $ ('#grado').val() + "&anio="+ $ ('#anio').val(),
        //data:"id="+ $ ('#lista1').val(),
        success:function(r){
...
$(document).ready(function(){
    ...
    if(idGradoPDF>0){
      window.open('../reportes/reporte_insolventes.php?idGrado='+idGradoPDF+'&anio='+anioPDF, '_blank');
    }else{
