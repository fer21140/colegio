...
?>
<title>Módulo | Ingresar planilla</title>
...
<div class="content-wrapper" onmousemove="calcularSalarioOrdinario()">
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Ingresar planilla</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class='form-group'>
                      ...
                      <select class='form-control selectAnio' name='anio' id='anio'>";
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="imprimirSueldo">
                                                <input type="number" class="form-control" placeholder="Salario ordinario (Q)" name="salarioOrdinario" id="salarioOrdinario" pattern="^[0-9.0-9]{1,10}" min="0" max="9999999999" required step="0.01">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label>Abono (Q)</label>
                                            <input type="number" class="form-control" placeholder="Abono (Q)" name="abono" id="abono" pattern="^[0-9.0-9]{1,10}" min="0" max="9999999999" required step="0.01">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" placeholder="Descuento (Q)" name="descuento" id="descuento" pattern="^[0-9.0-9]{1,10}" min="0" max="9999999999" required step="0.01">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" placeholder="Sueldo líquido (Q)" name="sueldoLiquido" id="sueldoLiquido" pattern="^[0-9.0-9]{1,10}" min="0" max="9999999999" required step="0.01" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Número de cheque" name="numeroCheque" id="numeroCheque" pattern="^[a-zA-ZáéíóúÁÉÍÓÚ0-9 ]{1,75}" required minlength="1" maxlength="75">
                                        </div>
                                    </div>
