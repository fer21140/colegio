...
?>
<title>Módulo | Editar planilla</title>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Editar datos de planilla</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-warning">
                        ...
                        ?>
                            ...
                            <form role="form" method="post" action="../crud/editarPlanilla.php?id=<?php echo $id; ?>">
                                <div class="row">
...
<?php
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="imprimirSueldo">
                                                <input type="number" class="form-control" placeholder="Salario ordinario (Q)" name="salarioOrdinario" id="salarioOrdinario" value="<?php echo $salarioOrdinario;?>" pattern="^[0-9.0-9]{1,10}" min="0" max="9999999999" required step="0.01">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label>Abono (Q)</label>
                                            <input type="number" class="form-control" placeholder="Abono (Q)" name="abono" id="abono" value="<?php echo $abono;?>" pattern="^[0-9.0-9]{1,10}" min="0" max="9999999999" required step="0.01">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" placeholder="Descuento (Q)" name="descuento" id="descuento" value="<?php echo $descuento;?>" pattern="^[0-9.0-9]{1,10}" min="0" max="9999999999" required step="0.01">
                                        </div>
                                    </div>
