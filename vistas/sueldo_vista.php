                                ...
                                ?>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" placeholder="Sueldo (Q)" name="sueldo" id="sueldo" value="<?php echo $sueldoQ;?>" pattern="^[0-9.]{1,10}" min="0" max="9999999999" required step="0.01" readonly>
                                        </div>
                                    </div>
