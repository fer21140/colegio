...
?>
  <title>Módulo | Editar tutor o encargado</title>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h1>Editar tutor o encargado del alumno/a <?php  echo "<td><h4><span class='badge bg-success'>$nombreAlumnoEtiqueta</span></h4></td>";?></h1>
          </div>
          <div class="col-sm-6">
