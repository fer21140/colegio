          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              <div class="card-body">
                ...
                <form role="form" method="post" action="../crud/ingresarGrado.php">
                  <div class="row">
                    
                  <div class="col-sm-6">
                      <!-- text input -->
                      <div class="form-group">
                        <label>Nombre del nuevo grado académico</label>
                        <input type="text" class="form-control" placeholder="Nombre del nuevo grado académico" name="nombre" id="nombre"
